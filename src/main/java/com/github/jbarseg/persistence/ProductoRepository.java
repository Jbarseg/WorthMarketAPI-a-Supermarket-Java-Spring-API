...
public class ProductoRepository implements ProductRepository {
    ...
    @Override
    public Optional<List<ProductDomain>> getByCategory (int productCategoryId){
        List<Product> products = productCrudRepository.findByIdCategoryOrderByNameAsc(productCategoryId);
